...
public class ReadFileWithBufferedReader {
  ...
  public ArrayList<Word> read() {
    return this.ReadJsonFile(
        "src/main/resources/Data/lingoes/empsOrigin.json");
  }
  public ArrayList<Word> readHistory() {
    return this.ReadJsonFile(
            "src/main/resources/Data/lingoes/History.json");
  }
  public ArrayList<Word> readFavouriteWord() {
    return this.ReadJsonFile(
